...
<Link href="/auth/signup" style={{ background: '#F6F9FB', color: '#1B3A57', padding: '15px 32px', borderRadius: '100px', textDecoration: 'none', fontSize: '0.95rem', fontWeight: 600, display: 'inline-block' }}>Begin a season &mdash; it is free</Link>
</section>
